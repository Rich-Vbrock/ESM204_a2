...
# values correlatig with emissions quantities
quant_600 <- 0.361002895751039
quant_300 <- 56.0540158661948
...
test_01 <- a_quant(56.05)
test_02 <- b_quant(56.05)
test_03 <- c_quant(56.05)
test_04 <- agg_quant(56.05)
...
# Question 3 - Cap on Carbon

a_quant_nocap <- a_quant(quant_600)
b_quant_nocap <- b_quant(quant_600)
c_quant_nocap <- c_quant(quant_600)

a_quant_cap <- a_quant(quant_600) - 100
b_quant_cap <- b_quant(quant_600) - 100
c_quant_cap <- c_quant(quant_600) - 100

cost_a <- a_eq(100)*100
cost_b <- b_eq(100)*100
cost_c <- c_eq(100)*100
cost_sum <- sum(cost_a, cost_b, cost_c)
...
# Country X (A:C) - Cut all emmissions in half
