...
y_trade_a <- y_quant_a - cap_abat_a
y_trade_b <- y_quant_b - cap_abat_b
y_trade_c <- y_quant_c - cap_abat_c
y_trade_d <- y_quant_d - 300
...
y_net_cost <- sum(y_net_a, y_net_b, y_net_c)
```
...
ggplot()+
  ...
  stat_function(aes(za), color = "darkgreen", fun = d_price, size = 1, show.legend = FALSE)+
